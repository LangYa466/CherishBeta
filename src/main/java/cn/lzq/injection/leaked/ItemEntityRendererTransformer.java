...
import cherish.modules.impl.render.ItemPhysic;
...
public class ItemEntityRendererTransformer extends ASMTransformer implements Wrapper {
    ...
    public static boolean isItemPhysicEnabled() {
        return cherish.INSTANCE.getModuleManager() != null
                && cherish.INSTANCE.getModuleManager().getModule(ItemPhysic.class) != null
                && cherish.INSTANCE.getModuleManager().getModule(ItemPhysic.class).isEnabled()
                && mc.player != null;
    }
