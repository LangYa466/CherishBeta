...
public class MinecraftTransformer extends ASMTransformer {
    ...
    public static void onPlace() {
        cherish.INSTANCE.getEventManager().call(new PlaceEvent());
    }

    public static void handleTickEvent() {
        FuckerUtils.a();
        cherish.INSTANCE.getEventManager().call(new TickEvent());
    }

    public static void handleWorldEvent() {
        cherish.INSTANCE.getEventManager().call(new WorldEvent());
    }

    public static void shutdownClient() {
        cherish.INSTANCE.shutdown();
    }
