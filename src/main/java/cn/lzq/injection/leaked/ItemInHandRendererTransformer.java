...
import cherish.modules.impl.render.Animations;
...
public class ItemInHandRendererTransformer extends ASMTransformer implements Wrapper {
    ...
    public static boolean isAnimationEnabled() {
        return cherish.INSTANCE != null
                ...
                && cherish.INSTANCE.getModuleManager().getModule(Animations.class) != null
                && cherish.INSTANCE.getModuleManager().getModule(Animations.class).isEnabled();
    }
