...
import cherish.modules.impl.combat.SuperKnockBack;
import cherish.modules.impl.misc.Disabler;
...
public class LocalPlayerTransformer extends ASMTransformer implements Wrapper {
    ...
    public static SlowEvent onSlow(boolean isUsingItem) {
        return (SlowEvent) cherish.INSTANCE.getEventManager().call(new SlowEvent(isUsingItem));
    }
    ...
    public static MotionEvent onMotion(double x, double y, double z, float yaw, float pitch, boolean onGround, boolean post) {
        return (MotionEvent) cherish.INSTANCE.getEventManager().call(new MotionEvent(x, y, z, yaw, pitch, onGround, post));
    }
    ...
    public static void onUpdateEvent() {
        cherish.INSTANCE.getEventManager().call(new UpdateEvent());
    }
    ...
    public static void onLivingUpdateEvent() {
        cherish.INSTANCE.getEventManager().call(new LivingUpdateEvent());
    }
