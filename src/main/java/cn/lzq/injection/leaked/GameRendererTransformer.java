...
import cherish.modules.impl.render.BetterCamera;
...
public class GameRendererTransformer extends ASMTransformer implements Wrapper {
    ...
    public static void onRender2D(float partialTicks) {
        ...
        if (cherish.INSTANCE != null && cherish.INSTANCE.getEventManager() != null)
            cherish.INSTANCE.getEventManager().call(new Render2DEvent(partialTicks, guiGraphics, guiGraphics.pose()));
    }

    public static void onRender3D(float partialTicks, PoseStack poseStack) {
        if (cherish.INSTANCE != null && cherish.INSTANCE.getEventManager() != null)
            cherish.INSTANCE.getEventManager().call(new Render3DEvent(partialTicks, poseStack));
    }
...
/*    public static boolean mouseOver() {
        ...
        cherish.INSTANCE.getEventManager().call(mouseOverEvent);
