...
import cherish.modules.impl.render.NameTags;
...
public class PlayerRendererTransformer extends ASMTransformer implements Wrapper {
    ...
    public static RenderPlayerEvent onRenderPlayer(PlayerRenderer this1, AbstractClientPlayer player, float rotationYaw, float rotationPitch) {
        ...
        return player == mc.player ? (RenderPlayerEvent) cherish.INSTANCE.getEventManager().call(new RenderPlayerEvent(this1, rotationYaw, rotationPitch)) : new RenderPlayerEvent(this1, rotationYaw, rotationPitch);
    }

    public static boolean nameTag() {
        return cherish.INSTANCE != null
                && cherish.INSTANCE.getModuleManager() != null
                && cherish.INSTANCE.getModuleManager().getModule(NameTags.class) != null
                && cherish.INSTANCE.getModuleManager().getModule(NameTags.class).isEnabled();
    }
