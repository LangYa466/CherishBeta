...
import cherish.modules.impl.movement.InvMove;
...
public class KeyMappingTransformer extends ASMTransformer {
    ...
    public static boolean guiMove() {
        return cherish.INSTANCE != null
                ...
                && cherish.INSTANCE.getModuleManager().getModule(InvMove.class) != null
                && cherish.INSTANCE.getModuleManager().getModule(InvMove.class).isEnabled();
    }
}
