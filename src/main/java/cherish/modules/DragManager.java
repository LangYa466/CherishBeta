...
public abstract class DragManager extends Module {
    ...
    protected void renderDragEffects(PoseStack poseStack) {
        ...
        if (alpha > 0.01f) {
            ...
            float textWidth = cherish.INSTANCE.getFontManager().tenacity20.getStringWidth(coords);
            ...
            poseStack.translate(-centerX, -centerY, 0);
            cherish.INSTANCE.getFontManager().tenacity20.drawString(poseStack, coords, coordX, coordY, new Color(255, 255, 255, (int)(alpha * 255)).getRGB());
            poseStack.popPose();
        }
    }
