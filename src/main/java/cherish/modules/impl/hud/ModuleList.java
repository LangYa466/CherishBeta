...
public class ModuleList extends DragManager {
    ...
    public void onTick(TickEvent event) {
        ...
        Collection<Module> modules = cherish.INSTANCE.getModuleManager().getModules();
        TrueTypeFont font = HUD.INSTANCE.languageValue.getValue().equals("English") ?
                cherish.INSTANCE.getFontManager().ax20 :
    ...
    private void calculateDimensions() {
        ...
        TrueTypeFont font = HUD.INSTANCE.languageValue.is("English") ?
                cherish.INSTANCE.getFontManager().ax18 :
                cherish.INSTANCE.getFontManager().zw18;
