...
import cherish.antileak.client.*;
import cherish.antileak.packet.impls.send.CPacketHandShake;
import cherish.antileak.utils.CryptUtil;
import cherish.antileak.utils.PacketWrapper;
import cherish.command.CommandManager;
import cherish.config.ConfigManager;
import cherish.event.EventManager;
import cherish.modules.impl.hud.MusicHUD;
import cherish.utils.font.FontManager;
import cherish.modules.ModuleManager;
import cherish.modules.impl.hud.ClickGui;
import cherish.utils.lyrics.LyricsServer;
import cherish.utils.misc.WebUtils;
import cherish.utils.resource.ResourcesManager;
import cherish.utils.*;
import cherish.utils.sound.SMTCUtil;
import cherish.utils.unsafe.SystemUtils;
...
public class cherish {
    ...
    public static final String CLIENT_NAME = "cherish";
    ...
    public static cherish INSTANCE = new cherish();
    ...
    public cherish() {
        ...
        if (index.exists()) {
            ...
            try {
                ...
                PacketWrapper.release(new CPacketHandShake(Client.channel, username, password, Fucker.getUUID(), "cherish", CLIENT_VERSION));
                init();
    ...
    public void loadClientResource() {
        ...
        this.CLIENT_ICON_PNG = resourcesManager.loadIconFromAbsolutePath(resourcesManager.resources.getAbsolutePath() + "\\icon\\" + "cherish.png");
    ...
    public void shutdown() {
        // Save Config
        cherish.INSTANCE.getModuleManager().getModule(ClickGui.class).setEnabled(false);
