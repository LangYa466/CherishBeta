...
public class ConfigManager {
    public final File mainFile = new File(System.getProperty("user.home"), ".moran" + File.separator + "cherish");
    ...
    public void init() {
        if (mc == null || cherish.INSTANCE == null) return;
