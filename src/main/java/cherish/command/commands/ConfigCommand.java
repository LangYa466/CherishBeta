...
import cherish.config.impl.module.SwitchModuleConfig;
    ...
    public void execute(String[] params) {
        if (params.length == 1) {
            if (params[0].equals("list")) {
                ...
                File[] files = cherish.INSTANCE.getConfigManager().configFile.listFiles();
            ...
            final SwitchModuleConfig switchModuleConfig = new SwitchModuleConfig(new File(cherish.INSTANCE.getConfigManager().configFile, params[1] + ".ini"));
            try {
