package cherish.ui.clickguis.compact;
...
import cherish.ui.clickguis.compact.impl.ModuleRect;
...
import static cherish.utils.math.MathUtils.lerp;
...
public class CompactClickGUI extends Screen implements Wrapper {
    ...
    protected CompactClickGUI() {
        ...
        // 收集所有HUD模块
        for (Module module : cherish.INSTANCE.getModuleManager().getModule(Category.RENDER)) {
    ...
    private void renderProfileSection(GuiGraphics guiGraphics, float x, float y, float sidebarWidth, float rectHeight) {
        ...
        // 获取字体
        TrueTypeFont nameFont = cherish.INSTANCE.getFontManager().tenacityBold14;
        TrueTypeFont infoFont = cherish.INSTANCE.getFontManager().tenacity14;
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        // Logo
        TrueTypeFont boldFont = cherish.INSTANCE.getFontManager().tenacityBold20;
        TrueTypeFont regularFont = cherish.INSTANCE.getFontManager().tenacity16;

        boldFont.drawString(guiGraphics.pose(), "cherish", animX + 10, y + 10, -1);
    ...
    private List<ModuleRect> getModuleRects(Category category) {
        ...
        if (!moduleRects.containsKey(category)) {
            ...
            for (Module module : cherish.INSTANCE.getModuleManager().getModule(category)) {
