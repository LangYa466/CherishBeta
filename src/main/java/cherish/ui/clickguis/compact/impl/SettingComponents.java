package cherish.ui.clickguis.compact.impl;
...
public class SettingComponents implements Wrapper {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        TrueTypeFont font = isEnglish ?
                cherish.INSTANCE.getFontManager().tenacity16 :
                cherish.INSTANCE.getFontManager().zw16;
        TrueTypeFont smallFont = isEnglish ?
                cherish.INSTANCE.getFontManager().tenacity14 :
                cherish.INSTANCE.getFontManager().zw14;
    ...
    private void drawAnimatedArrow(GuiGraphics guiGraphics, float x, float y, float size, boolean expanded, float animationProgress, int color) {
        ...
        String arrowChar = "▼";
        TrueTypeFont font = cherish.INSTANCE.getFontManager().zw12;
