package cherish.ui.notification;

import com.mojang.blaze3d.platform.Window;
import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.blaze3d.vertex.PoseStack;
import cherish.cherish;
import cherish.utils.StopWatch;
...
public class NotificationManager implements Wrapper {
    ...
    private static final FontManager fontManager = cherish.INSTANCE.getFontManager();
    ...
    public static void drawTopNotifications(PoseStack poseStack) {
        final String defaultText = cherish.CLIENT_NAME + " | " + mc.player.getName().getString() + " | " + (Objects.requireNonNull(mc.getCurrentServer()).ip);
    ...
    private static void drawDefault(PoseStack poseStack,  float x) {
        ...
        RenderUtils.drawImage(poseStack,cherish.INSTANCE.CLIENT_ICON_PNG, (int) (x + 6.0f), (int) 17f, 17, 17, 0,0,17,17);

        clientNameFont.drawString(poseStack,cherish.CLIENT_NAME, x +
                        26.0f
                , 19.5f, color);

        I.drawString(poseStack," §7|§r ", x +
                        23.0f +
                        clientNameFont.getStringWidth(cherish.CLIENT_NAME)
        ...
        font_.drawString(poseStack,"§7v" + cherish.CLIENT_VERSION, x +
                        20.0f +
                        clientNameFont.getStringWidth(cherish.CLIENT_NAME)+
                        I.getStringWidth(" §7|§r ")
